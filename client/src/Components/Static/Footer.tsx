import { Box, Divider, Flex, Image, Text, Stack, useDisclosure } from "@chakra-ui/react";
    ...
    <Box bgColor={"black"} w={"100%"} h={64}>
      <Flex w={"100%"} h={"100%"}>
        ...
        <Box w={"100%"} h={"100%"} m={"auto"}>
          <Stack h={"100%"} direction={"column"} spacing="24px" justifyContent={"space-evenly"} py={"10%"}>
            <Text textColor={"white"} textAlign={"center"}>
              Nuestros productos son hechos 100% a mano.
            </Text>
            <Text textColor={"white"} textAlign={"center"}>
              Por consultas podes escribinos a nuestras redes sociales o enviarnos tu consuta{" "}
              <span onClick={onOpen} style={{ color: "blue", cursor: "pointer" }}>
                aqui
              </span>
              .
            </Text>
